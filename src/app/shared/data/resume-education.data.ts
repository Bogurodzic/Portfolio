...
export const education: IResumeEducation[] = [
    {
        ...
        description: 'Gained knowledge about math, programming, algorithms, data structures and basic knowledge about computer architecture, with specialization in Mobile App Development.'
    },
    {
        dateStart: 'Nov 2020',
        dateEnd: 'Nov 2021',
    ...
    },
    {
        ...
        place: 'Udacity',
        description: 'A 4-month online course, during which I obtained the fundamental knowledge of how the web works and got a working knowledge of the three foundational languages that power each and every website: HTML, CSS and JavaScript.'
    },
    {
        dateStart: 'Jan 2016',
        category: 'Front-End Web Developer Nanodegree',
        place: 'Eduweb',
        description: 'A 3-month online course, during which I obtained the knowledge how HTML5 API works, and learned how to work efficiently using ES6, Webpack, Git and Gulp.'
    },
]
